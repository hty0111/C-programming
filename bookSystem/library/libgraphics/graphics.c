...
static void InitColors(void)
{
    ...
    DefineColor("Ivory",1,1,.94);
    DefineColor("Azure",.94,1,1);
    DefineColor("Gainsboro",.86,.86,.86);
    DefineColor("MidnightBlue",.1,.1,.44);
    DefineColor("SlateBlue",.42,.35,.8);
    DefineColor("IndianRed2",.93,.39,.39);
    DefineColor("CornflowerBlue",.39,.58,.93);
    DefineColor("MediumBlue",0,0,.8);
    DefineColor("Seashell",1,.96,.93);
    DefineColor("Firebrick1",1,.19,.19);
    DefineColor("Salmon",.98,.5,.45);
    DefineColor("WhiteSmoke",.96,.96,.96);
}
